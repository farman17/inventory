...
if ($MySQLi_CON->query($sql) == TRUE) {
	...
	$kegiatan = "Mengurangi stok barang ".$row->nama_barang." berjulmah ".$row->stok_barang." sebanyak ".$jumlah." sehingga stok barang ".$row->nama_barang." menjadi ".$hasil_stok;
	...
	<body>
		...
		<section class="content">
			...
			<form method="post">
				...
				<input type="number" name="jumlah" value="0" min="0" max="<?php echo $row->stok_barang;?>" placeholder="Jumlah" required/><strong>*Jumlah</strong>
				</br>
